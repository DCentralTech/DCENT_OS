...
pub static ANTMINER_MODELS: &[ModelEvidence] = &[
    ...
    model!("s17plus", 0x1396, 3, Some(65), 115_740, 7, None, None, None, Structural, &[MASTER_MODELS, ""]),
    model!("t17plus", 0x1396, 3, Some(44), 115_740, 7, None, None, None, Structural, &[MASTER_MODELS, ""]),
    model!("s17e", 0x1397, 3, None, 115_740, 7, None, None, None, Structural, &[MASTER_MODELS, ""]),
