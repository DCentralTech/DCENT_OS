...
cat > "$SUP_DIR/MANIFEST.json" << EOF
{
  ...
  "toolbox": {
    "install_command": "dcent install <ip> -f dcentos-sysupgrade-am2-s19pro.tar",
    "update_command": "dcent install <ip> -f dcentos-sysupgrade-am2-s19pro.tar",
...
DCENT_TOOLBOX_INSTALL_COMMAND="dcent install <ip> -f dcentos-sysupgrade-am2-s19pro.tar"
