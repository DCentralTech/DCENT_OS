#!/bin/sh
#
# revert_to_stock_s9.sh — Revert an S9 am1 from DCENTos back to stock
# Bitmain firmware.  W12-B renamed from revert_to_stock.sh so
# the per-platform scripts (am335x_bb, am3_aml_s21, am3_aml_s19k) sit
# alongside it without filename collisions. Logic UNCHANGED from
# wave-≤11 — this script is the live-tested path the dcentrald
# PROFILE_TABLE.zynq-am1-bm1387 entry points at via
...
#
# Usage:
#   ./revert_to_stock_s9.sh [firmware_image.tar.gz]
#
